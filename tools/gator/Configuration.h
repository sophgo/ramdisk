...
static inline bool operator==(const SpeConfiguration &lhs,
			      const SpeConfiguration &rhs)
{
...
template <> struct hash<SpeConfiguration> {
	...
	result_type
	operator()(const argument_type &speConfiguration) const noexcept
	{
...
static inline bool operator==(const CounterConfiguration &lhs,
			      const CounterConfiguration &rhs)
{
...
template <> struct hash<CounterConfiguration> {
	...
	typedef std::size_t result_type;
	result_type
	operator()(const argument_type &counterConfiguration) const noexcept
	{
