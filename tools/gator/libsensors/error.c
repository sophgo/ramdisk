					    ...
					    const char *filename, int lineno)
{
	...
	if (sensors_parse_error != sensors_default_parse_error || !filename)
...
void (*sensors_parse_error)(const char *err,
			    int lineno) = sensors_default_parse_error;
void (*sensors_parse_error_wfn)(const char *err, const char *filename,
				int lineno) = sensors_default_parse_error_wfn;
void (*sensors_fatal_error)(const char *proc,
			    const char *err) = sensors_default_fatal_error;
