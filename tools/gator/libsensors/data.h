...
#define sensors_add_config_files(el)                                           \
	sensors_add_array_el((el), &sensors_config_files,                      \
			     &sensors_config_files_count,                      \
...
#define sensors_add_proc_chips(el)                                             \
	sensors_add_array_el((el), &sensors_proc_chips,                        \
			     &sensors_proc_chips_count,                        \
			     &sensors_proc_chips_max,                          \
			     sizeof(struct sensors_chip_features))

extern sensors_bus *sensors_proc_bus;
extern int sensors_proc_bus_count;
extern int sensors_proc_bus_max;

#define sensors_add_proc_bus(el)                                               \
	sensors_add_array_el((el), &sensors_proc_bus, &sensors_proc_bus_count, \
