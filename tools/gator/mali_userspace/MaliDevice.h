...
struct IMaliDeviceCounterDumpCallback {
	...
	virtual void nextCounterValue(uint32_t nameBlockIndex,
				      ...
				      uint32_t gpuId, IBuffer &buffer) = 0;
	...
	/**
         ...
         */
	virtual bool isCounterActive(uint32_t nameBlockIndex,
				     uint32_t counterIndex,
				     uint32_t gpuId) const = 0;
};
...
class MaliDeviceCounterList {
	...
	/**
             ...
             * @param numWords
             */
	MaliDeviceCounterList(uint32_t numBlocks, uint32_t numGroups,
			      uint32_t numWords);
	...
	/**
             ...
             * @param wordIndex
             */
	void enable(MaliCounterBlockName nameBlock, uint32_t repeatCount,
		    uint32_t groupIndex, uint32_t wordIndex);
...
class MaliDevice {
	...
	enum {
		...
		NUM_ENABLE_GROUPS =
			NUM_COUNTERS_PER_BLOCK / NUM_COUNTERS_PER_ENABLE_GROUP,
	...
	/**
         ...
         */
	static std::unique_ptr<MaliDevice>
	create(std::unique_ptr<IMaliDeviceApi> deviceApi,
	...
	/**
         ...
         */
	const char *getCounterName(uint32_t nameBlockIndex,
	...
	/**
         ...
         */
	MaliDeviceCounterList
	createCounterList(IMaliDeviceCounterDumpCallback &callback) const;
	...
	/**
         ...
         */
	lib::AutoClosingFd createHwCntReaderFd(
	...
	/**
         ...
         */
	void
	dumpAllCounters_V56(const MaliDeviceCounterList &counterList,
			    const uint32_t *buffer, size_t bufferLength,
			    IBuffer &bufferData,
			    IMaliDeviceCounterDumpCallback &callback) const;
};
