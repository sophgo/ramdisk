...
class MaliHwCntrReader : public IMaliHwCntrReader {
	...
	/**
         ...
         */
	static std::unique_ptr<MaliHwCntrReader>
	createReader(const MaliDevice &device);
	...
	/**
         ...
         */
	static std::unique_ptr<MaliHwCntrReader>
	create(const MaliDevice &device, CounterBitmask jmBitmask,
	       CounterBitmask shaderBitmask, CounterBitmask tilerBitmask,
