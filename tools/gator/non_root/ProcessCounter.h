...
namespace non_root
{
enum class AbsoluteProcessCounter : typename std::underlying_type<
	NonRootCounter>::type {
	DATA_SIZE = NonRootCounterValue(NonRootCounter::PROCESS_ABS_DATA_SIZE),
	NUM_THREADS =
		NonRootCounterValue(NonRootCounter::PROCESS_ABS_NUM_THREADS),
	...
	SHARED_SIZE =
		NonRootCounterValue(NonRootCounter::PROCESS_ABS_SHARED_SIZE),
