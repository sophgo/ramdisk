...
static constexpr typename std::underlying_type<NonRootCounter>::type
NonRootCounterValue(NonRootCounter nrc)
{
	return static_cast<typename std::underlying_type<NonRootCounter>::type>(
		nrc);
}
} // namespace non_root
