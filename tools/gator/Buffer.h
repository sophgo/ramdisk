...
class Buffer : public IBuffer {
    public:
	Buffer(int32_t core, FrameType frameType, const int size,
	...
	bool counterMessage(uint64_t curr_time, int core, int key,
			    int64_t value);
	bool threadCounterMessage(uint64_t curr_time, int core, int tid,
