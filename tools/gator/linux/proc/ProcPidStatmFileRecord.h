...
class ProcPidStatmFileRecord {
	...
	/**
         ...
         */
	static bool parseStatmFile(ProcPidStatmFileRecord &result,
	...
	/**
         ...
         */
	ProcPidStatmFileRecord(unsigned long size, unsigned long resident,
			       unsigned long shared, unsigned long text,
			       unsigned long lib, unsigned long data,
			       unsigned long dt);
