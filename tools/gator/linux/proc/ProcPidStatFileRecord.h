...
class ProcPidStatFileRecord {
	...
	/**
         ...
         */
	static bool parseStatFile(ProcPidStatFileRecord &result,
	...
	/**
         ...
         */
	ProcPidStatFileRecord(int pid, const char *comm, char state, int ppid,
			      int pgid, int session, int tty_nr, int tpgid,
			      unsigned flags, unsigned long minflt,
			      unsigned long cminflt, unsigned long majflt,
			      unsigned long cmajflt, unsigned long utime,
			      unsigned long stime, long cutime, long cstime,
			      long priority, long nice, long num_threads,
			      long itrealvalue, unsigned long long starttime,
			      unsigned long vsize, long rss,
			      unsigned long rsslim, unsigned long startcode,
			      unsigned long endcode, unsigned long startstack,
			      unsigned long kstkesp, unsigned long kstkeip,
			      unsigned long signal, unsigned long blocked,
			      unsigned long sigignore, unsigned long sigcatch,
			      unsigned long wchan, unsigned long nswap,
			      unsigned long cnswap, int exit_signal,
			      int processor, unsigned rt_priority,
			      unsigned policy,
