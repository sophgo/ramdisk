...
struct PerfDriverConfiguration {
	...
	PerfConfig config{ false, false, false, false, false, false, false,
			   false, false, false, false, false, false, false };

	static std::unique_ptr<PerfDriverConfiguration>
	detect(bool systemWide, lib::Span<const int> cpuIds,
	       const PmuXML &pmuXml);
